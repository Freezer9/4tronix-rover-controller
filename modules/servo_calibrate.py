...
try:
    ...
    print('Servo: Front Left: Offset:',
          rover.servoOffsets[servo+positionoffset], sep='')
    ...
    while True:
        ...
        rover.writePWM(servo, value)
        print('Servo ', servo, ': Value ', value, ': Offset:',
              rover.servoOffsets[servo+positionoffset], sep='')
